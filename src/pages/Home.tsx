    ...
    <>
      ...
      <div className="text-white d-flex flex-column justify-content-start align-items-start rounded vw-100" style={{ minHeight: "calc(100vh - 80px)" }}>
        <div className="d-flex justify-content-around align-items-center w-100 mt-4">
          <div className="bg-dark px-3 py-2 rounded fs-4 d-flex flex-column justify-content-center align-items-start" style={{ width: '200px' }}>
            <div className="d-flex justify-content-between align-items-center w-100">
              <h1 className="fs-3 fw-light m-0 text-primary">Saldo</h1>
              <svg width="20" height="20" fill="currentColor" className="bi bi-wallet2 text-primary" viewBox="0 0 16 16">
                <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9a1.5 1.5 0 0 1 1.432-1.499zM5.562 3H13V1.78a.5.5 0 0 0-.621-.484zM1.5 4a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5z"/>
              </svg>
            </div>
            <p className="m-0">R$4.284,00</p>
          </div>
          <div className="bg-dark px-3 py-2 rounded fs-4 d-flex flex-column justify-content-center align-items-start" style={{ width: '200px' }}>
            <div className="d-flex justify-content-between align-items-center w-100">
              <h1 className="fs-3 fw-light m-0 text-success">Receita</h1>
              <svg width="20" height="20" fill="currentColor" className="bi bi-cash-coin text-success" viewBox="0 0 16 16">
            ...
            <p className="m-0">R$2.138,00</p>
          </div>
          <div className="bg-dark px-3 py-2 rounded fs-4 d-flex flex-column justify-content-center align-items-start" style={{ width: '200px' }}>
            <div className="d-flex justify-content-between align-items-center w-100">
              <h1 className="fs-3 fw-light m-0 text-danger">Despesa</h1>
              <svg width="20" height="20" fill="currentColor" className="bi bi-cash text-danger" viewBox="0 0 16 16">
                <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4"/>
                <path d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2z"/>
              </svg>
            </div>
            <p className="m-0">R$1.986,00</p>
          </div>
        </div>
        <div className="">
